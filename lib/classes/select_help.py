    ...
    def format_page(self, menu: HelpMenu, page):
        ...
        if self.index == 0:
            embed.add_field(
                name='Who are you?',
                value=(
                    ":pray: Konichiwa :pray:, I am **ANBU**, **Black Ops of Konohagakure <:uzumaki_naruto:874930645405675521>**"
                    f'I joined discord on {created_at}. I try my best to do every work of a **ANBU**. You can get more '
                    'information on my commands by using the *dropdown* below.\n\n'
                    "I'm also open source. You can see my code on [GitHub](https://github.com/Dhruvacube/shawpujabot)!"
                ),
                inline=False,
            )
        elif self.index == 1:
