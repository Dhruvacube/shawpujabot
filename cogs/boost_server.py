...
class BoostPlugin(commands.Cog):
    ...
    def display_emoji(self) -> discord.PartialEmoji:
        return discord.PartialEmoji(
            name="nitro1", id="852813350545915905", animated=True
        )
    ...
    async def send_nitro_boost_message(self, ctx, member: discord.Member):
        ...
        embed.set_thumbnail(
            url="https://cdn.discordapp.com/emojis/852813350545915905.gif?v=1"
        )
    ...
    async def send_nitro_level_message(self, ctx, level: int):
        ...
        if level == 1:
            embed.set_thumbnail(
                url="https://cdn.discordapp.com/emojis/627044920431214593.gif?v=1"
            )
        elif level == 2:
            embed.set_thumbnail(
                url="https://cdn.discordapp.com/emojis/627044920431214593.gif?v=1"
    ...
    async def on_message(self, message):
        ...
        if message.type == discord.MessageType.premium_guild_subscription:
            try:
                ...
                desc = (
                    "Thank you so much for **boosting** <a:nitro1:852813350545915905> !"
                )
        ...
        if message.type == discord.MessageType.premium_guild_tier_2:
            ...
            embed.set_thumbnail(
                url="https://cdn.discordapp.com/emojis/852801854869340172.gif?v=1"
            )
            m = await channel_message.send(embed=embed)
            await m.add_reaction("<a:love_heart:852813348101816370>")
        ...
        if message.type == discord.MessageType.premium_guild_tier_3:
            ...
            embed.set_thumbnail(
                url="https://cdn.discordapp.com/emojis/701335073387053106.gif?v=1"
            )
            m = await channel_message.send(embed=embed)
            await m.add_reaction("<a:love_heart:852813348101816370>")
